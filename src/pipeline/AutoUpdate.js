...
export const DEFAULT_AUTOUPDATE_TEMPLATE = [
  ...
  'Any parenthetical must be a brief STATE / CONDITION only — never appearance, composition, effects, numbers,',
  'or rules. Appearance and effects belong in the description, generated separately and read back each turn.',
  '',
  '# Tracked entities',
...
const COMMANDS_HELP = [
  ...
  'parenthetical must be a brief STATE / CONDITION — never appearance, composition, or effects; those go in the',
  'description, generated separately and read each turn.',
