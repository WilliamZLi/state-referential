...
export const DEFAULT_AUTOUPDATE_TEMPLATE = [
  ...
  'Any parenthetical must be a brief STATE / CONDITION only (e.g. "staff (broken)", "robes (soaked)", "gem',
  '(cracked)") — never appearance, composition, effects, numbers, or rules. e.g. "vibrating nipple barbells",',
  'NOT "vibrating nipple barbells (matched pair, weighted teardrop chains)". Appearance and effects belong in',
  'the description, which is generated separately and read back each turn.',
  '',
  '# Tracked entities',
...
const COMMANDS_HELP = [
  ...
  'For describable fields (SET a text value OR ADD a list entry), keep the value a SHORT, succinct name. Any',
  'parenthetical must be a brief STATE / CONDITION (e.g. "(broken)", "(soaked)") — never appearance, composition,',
  'or effects; those go in the description, generated separately and read each turn.',
