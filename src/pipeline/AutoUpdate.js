...
export const DEFAULT_AUTOUPDATE_TEMPLATE = [
  ...
  '',
  'For describable fields (outfit slots, conditions, status effects, items), SET or ADD only a SHORT bare name',
  '— e.g. "nipple barbells", NOT "nipple barbells (enchanted, vibrating, locks the top…)". Never pack',
  'appearance, effects, numbers, rules, or parentheticals into the value; the description is generated',
...
const COMMANDS_HELP = [
  ...
  'For describable fields (SET a text value OR ADD a list entry), use a SHORT bare name only — no',
  'appearance, effects, numbers, or parentheticals. The description is generated separately and read each turn.',
